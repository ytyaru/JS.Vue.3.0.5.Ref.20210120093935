...
* [DEMO](https://ytyaru.github.io/JS.Vue.3.0.5.Ref.20210120093935/)
...
1. Start the terminal
    1. Move the current directory. To the path where index.html is. `cd JS.Vue.3.0.5.Ref.20210120093935 / src`
